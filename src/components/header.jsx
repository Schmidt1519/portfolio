        ...
        <Stack>
            <Flex direction={isNotSmallScreen ? "row" : "column"}
                ...
                <Box mt={isNotSmallScreen ? "0" : "16"} align="flex-start">
                    ...
                    <Text color={isDark ? "gray.200" : "gray.500"} mt="3">I live in the Kansas City metro and when not spending time with family or coding, I enjoy working out and playing sports, concerts, cryptocurrencies, and traveling to Colorado for outdoor adventures.</Text>

                    <Link href="https://schmidt1519.github.io/resume/" isExternal>
                        <Button mt={5} colorScheme="blue" bg="blue.400" color="white" _hover={{ bg: "teal.400" }}>My Resume</Button>
                    </Link>
                </Box>
